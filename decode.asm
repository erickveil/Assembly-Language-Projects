...
.FARDATA	DSEG
	...
	MASK_B	DW	0000000001110000B
	MASK_C	DW	0000000100000000B
...
MAIN	PROC	FAR
	...
	PUSH	CX
		...
		; Resets value storage
		MOV		BADVAL,0000B
		MOV		BITSET,0100000000000B
	POP		CX
	LOOP	MAIN_LOOP
...
COMMENT*
	...
	Erick Veil
	10-16-11
	PRE: Pass corrected 11 bit PACKET via the stack
	POST: Masks out the data bits and sets them to 
	a value returned via AX
*
DECODE	PROC	NEAR PUBLIC	PACKET:WORD
	PUSHF
